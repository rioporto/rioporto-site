...
-- SCRIPT SEGURO COM LIMPEZA
-- ========================================
-- Última atualização: 25/06/2025
-- 
-- Este script remove estruturas antigas e 
-- cria todas as tabelas do zero
-- ========================================

-- PARTE 1: LIMPEZA (CUIDADO - Remove estruturas existentes!)
-- ========================================
...
-- ========================================
-- PARTE 2: CRIAÇÃO DAS ESTRUTURAS
-- ========================================
...
-- Adicionar a foreign key para parent_id após a tabela ser criada
...
-- FIM DO SCRIPT
-- ========================================
-- Se tudo correu bem, você deve ver 5 tabelas listadas
-- ========================================