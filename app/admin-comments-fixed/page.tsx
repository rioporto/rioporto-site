...
export default function AdminCommentsFixedPage() {
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b">
        <div className="container flex h-16 items-center justify-between">
          <h1 className="text-xl font-bold">Admin - Comentários</h1>
      ...
      <main className="container max-w-6xl py-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold mb-2">Moderar Comentários</h2>
